...
try:
    ...
    logger.warning("You won't be able to use the cannelloni can backend without the socket module installed!")
    socket = None
    import socket
...
class CannelloniBus(BusABC):
    ...
    def __init__(self, ap_address, state=BusState.ACTIVE, bitrate=500000, can_mode=CANNELLONI_CAN_MODE_NORMAL,
                 ...
                 sleep_after_open=__SLEEP_AFTER_SOCKET_OPEN, **kwargs):
        """
        ...
        # get configuration for the Cannelloni Interface
        ...
        self.__local_address = ('192.168.4.2', 3333)  # local IP-Address and local Port
        ...
        # open the connection to the Cannelloni Interface
        self.open()  # TODO: adapt
        time.sleep(sleep_after_open)

        # start the internal receive  thread
